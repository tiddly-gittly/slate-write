...
files['test/wikiast-util-from-slate-plate-ast.test.ts'] = await fs.readFile('test/wikiast-util-from-slate-plate-ast.test.ts', 'utf8');
...
files['test/end-to-end.test.ts'] = files['test/end-to-end.test.ts'].replace(
  placeholder,
...
files['test/wikiast-util-from-slate-plate-ast.test.ts'] = files['test/wikiast-util-from-slate-plate-ast.test.ts'].replace(
  placeholder,
  `  test('${newTestCaseName}', () => {
...
files['test/wikiast-util-from-wikitext.test.ts'] = files['test/wikiast-util-from-wikitext.test.ts'].replace(
  placeholder,
  `  test('${newTestCaseName}', () => {
...
files['test/wikiast-util-to-slate-plate-ast.test.ts'] = files['test/wikiast-util-to-slate-plate-ast.test.ts'].replace(
  placeholder,
  `  test('${newTestCaseName}', () => {
...
files['test/wikiast-util-to-wikitext.test.ts'] = files['test/wikiast-util-to-wikitext.test.ts'].replace(
  placeholder,
  `  test('${newTestCaseName}', () => {
...
await fs.writeFile('test/wikiast-util-from-slate-plate-ast.test.ts', files['test/wikiast-util-from-slate-plate-ast.test.ts'], 'utf8');
